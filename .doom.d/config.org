...
(setq org-agenda-prefix-format '((agenda . " %i %?-12t%?-7s%?-5e")
                                 (todo . " %i %-8:c")
                                 (tags . " %i %-8:c")
                                 (search . " %i %-8:c")))
(setq org-agenda-time-grid '((daily today remove-match)
                             ...
                             " ┄┄┄┄┄ " ""))
(setq org-agenda-scheduled-leaders '("Sched: " "!!%dx: "))
(setq org-agenda-deadline-leaders '("Due: " "In %dd: " "%2dd ago: "))
...
with a timestamp)."
  ;; (print (get-text-property 1 'date a))
  ;; (print (get-text-property 1 'type a))
  ;; (print (format "%s" a))
...
#+begin_src emacs-lisp :tangle yes
(setq org-agenda-sorting-strategy '((agenda user-defined-up category-keep habit-up scheduled-up deadline-up todo-state-up priority-down effort-up)
                                   ...
                                   ("D" "Daily TODOs for a week"
                                    ((agenda "" ((org-agenda-span 1)
                                     ...
                                     (agenda "" ((org-agenda-span 6)
                                                 (org-agenda-start-day "+1d")
                                                 (org-agenda-dim-blocked-tasks nil)
                                                 (org-agenda-skip-function '(org-agenda-skip-entry-if 'todo '("HABIT" "TYPE")))
                                                 (org-agenda-use-time-grid nil)))))
                                   ("tp" "Project TODOs"
...
(setq org-todo-keywords '((sequence "TODO(t)" "SCHD(s)" "HABIT(h!)" "LOOP(l!)" "TYPE(y!)" "PROJIDEA(r)" "PROJ(p)" "NEXT(n)" "WAIT(w@/@)" "IDEA(i)" "SOMEDAY(m)" "NOTE(o)" "|" "DONE(d!)" "KILL(k@)")))
