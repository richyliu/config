...
#+begin_src emacs-lisp :tangle yes
(setq org-agenda-sorting-strategy '((agenda user-defined-up category-keep habit-up scheduled-up deadline-up todo-state-up priority-down)
...
(setq org-agenda-custom-commands '(("d" "Daily agenda and TODOs"
                                   ...
                                   ("D" "Daily TODOs for a week"
                                    ((agenda "" ((org-agenda-span 7)
                                                 (org-agenda-start-day "0d")
                                                 (org-agenda-dim-blocked-tasks nil)
                                                 (org-agenda-skip-function '(org-agenda-skip-entry-if 'todo '("HABIT" "LOOP" "TYPE")))
