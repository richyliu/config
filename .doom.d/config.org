                                    ...
                                    ((todo "TODO" ((org-agenda-overriding-header "Inbox TODOs")
                                     ...
                                     (todo "PROJ" ((org-agenda-overriding-header "Projects")
                                                   ...
                                                   (org-agenda-sorting-strategy
                                                    (cons '(todo priority-down alpha-up) org-agenda-sorting-strategy))))
                                     (todo "NEXT")
...
(setq org-todo-keywords '((sequence "TODO(t)" "PROJ(p)" "LOOP(l!)" "HABT(h!)" "WAIT(w@/@)" "NEXT(n)" "IDEA(i)" "SOMEDAY(m)" "NOTE(o)" "|" "DONE(d!)" "KILL(k@)")))
